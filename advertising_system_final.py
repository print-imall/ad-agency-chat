...
def main():
    ...
    <div style="text-align: center; margin-bottom: 2rem;">
        ...
        <div style="background: rgba(255, 255, 255, 0.9); padding: 1rem; border-radius: 15px; margin-top: 1rem;">
            <h3 style="color: #56ab2f; margin-bottom: 0.5rem;">✨ חדש! מערכת אוטומטית</h3>
            <p style="margin: 0; color: #666;">הנתונים והתמונות נטענים אוטומטית מהענן - אין צורך להעלות קבצים!</p>
        </div>
    </div>
    """, unsafe_allow_html=True)
                            ...
                            if images:
                                ...
                                for i, (item_code, image_path) in enumerate(images):
                                    with cols[i % 3]:
                                        ...
                                        st.caption(f"מק״ט: {item_code}")image(image_path)
